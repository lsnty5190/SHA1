...
def test(key, message):
    #hmac = HMAC(bytes(key, 'utf-8'), bytes(message, 'utf-8'), hashlib.sha1)
    digester = digest(bytes(key, 'utf-8'), bytes(message, 'utf-8'), hashlib.sha1)
    print(digester.hex())
...
if __name__ == '__main__':
    ...
    #print(hex(digest))
    test("keykkk", "The quick brown fox jumps over the lazy dog")
